...
const handleBack = ()=>{
  ...
  <button className='backButton'  onClick={handleBack} > <CloseIcon></CloseIcon> Close</button>
    ...
    {val != ""?  <iframe style={{height:"25vw" , width:"100%"}} src={val} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe> : null }
